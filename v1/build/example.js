var InputText = React.createClass({displayName: "InputText",
  ...
  render: function () {    
    return (
      React.createElement("input", {type: "text", ref: "theInput", onFocus: this.handleFocus, onBlur: this.handleBlur, onChange: this.handleChange})
    )
  }
});

var Text01 = ReactDOM.render(
  React.createElement(InputText, {text: "欄位01"}),
  document.getElementById('example01')
);
var Text02 = ReactDOM.render(
  React.createElement(InputText, {text: "欄位02"}),
  document.getElementById('example02')
);
var Text03 = ReactDOM.render(
  React.createElement(InputText, {text: "欄位03"}),
